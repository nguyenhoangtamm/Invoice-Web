...
import { createOrganization } from '../api/services/organizationService';
...
const AddOrganizationModal: React.FC<AddOrganizationModalProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await createOrganization(apiPayload);
            ...
            if (response.succeeded) {
                ...
                // Handle API error
                const errorMessage = response.message || 'Có lỗi xảy ra khi tạo tổ chức';
                showToast({
                    type: 'error',
                    title: 'Lỗi',
            ...
            setErrors({ name: 'Có lỗi xảy ra khi tạo tổ chức' });
        } finally {
            setLoading(false);
        }
    };

    const handleInputChange = (field: keyof CreateOrganizationFormData, value: string | boolean) => {
            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-semibold text-gray-900">Thêm tổ chức mới</h2>
                    </div>
                    <button
                        onClick={onClose}
