            ...
            <div className="max-w-4xl mx-auto px-4">
                <div className="bg-white rounded-lg shadow-sm p-8">
                    ...
                    <div className="prose max-w-none text-gray-700">
                        ...
                        <p className="mb-6">
                            Bằng việc truy cập và sử dụng dịch vụ TrustInvoice, bạn đồng ý tuân thủ và bị ràng buộc bởi
                        ...
                        <p className="mb-6">
                            TrustInvoice là một nền tảng cung cấp dịch vụ tra cứu và quản lý hóa đơn điện tử.
                        ...
                        <p className="mb-6">
                            Tất cả nội dung, tính năng và chức năng của TrustInvoice (bao gồm nhưng không giới hạn ở văn bản,
                        ...
                        <p className="mb-6">
                            Trong phạm vi tối đa được pháp luật cho phép, TrustInvoice không chịu trách nhiệm đối với bất kỳ
